        ...
        for i in idxes:
            ...
            for el in data:
                if self.q_lstm_on and self.p_lstm_on:
                    ...
                    obs_t, action, reward, obs_tp1, done, q_c_in_t, q_h_in_t, q_c_out_t, q_h_out_t= el
                elif self.p_lstm_on:
                    obs_t, action, reward, obs_tp1, done, p_c_in_t, p_h_in_t, p_c_out_t, p_h_out_t= el
                else:
                    obs_t, action, reward, obs_tp1, done = el
